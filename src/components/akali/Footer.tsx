...
export function Footer() {
  ...
  return (
    <footer className="relative grain border-t border-border py-20 z-10">
        ...
        <div className="grid gap-12 md:grid-cols-3">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              {t.footer.craftedBy}<span className="accent-text">Christian</span> · 2026
            </p>
          </div>
          <nav className="flex flex-col gap-3 text-sm">
            ...
            <a
              ...
              className="group flex items-center justify-between border-b border-border py-2 transition-colors hover:accent-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded"
            >
              <span>GitHub</span>
